...
(define (atangent x y) (apply-generic 'atan x y))
...
(define (install-integer-package)
  ...
  (put 'sin '(integer) (lambda (x) (drop (make-real (sin x)))))
  (put 'cos '(integer) (lambda (x) (drop (make-real (cos x)))))
  (put 'atan '(integer integer) (lambda (x y) (make-real (atan x y))))
  (put 'sqrt '(integer) (lambda (x) (drop (make-real (sqrt x)))))
...
(define (install-rational-package)
  ...
  (put 'sin '(rational) (lambda (x) (drop (make-real (sin (/ (numer x) (denom x)))))))
  (put 'cos '(rational) (lambda (x) (drop (make-real (cos (/ (numer x) (denom x)))))))
  (put 'atan '(rational rational) (lambda (x y) (make-real (atan (/ (numer x) (denom x))
								 (/ (numer y) (denom y))))))
  (put 'sqrt '(rational) (lambda (x) (drop (make-real (sqrt (/ (numer x) (denom x)))))))
  (put 'square '(rational) (lambda (x) (let ((n (numer x))
					     (d (denom x)))
					 (drop (tag (make-rat (* n n) (* d d)))))))
  'done)
...
(define (install-real-package)
  ...
  (put 'sin '(real) (lambda (x) (drop (tag (sin x)))))
  (put 'cos '(real) (lambda (x) (drop (tag (cos x)))))
  (put 'atan '(real real) (lambda (x y) (tag (atan x y))))
  (put 'sqrt '(real) (lambda (x) (drop (tag (sqrt x)))))
...
(project (make-complex-from-real-imag (make-integer 1) (make-integer 2)))
...
(add (make-complex-from-real-imag (make-integer 1) (make-integer 0)) (make-rational 1 2))
(add (make-complex-from-real-imag (make-integer 1) (make-integer 1)) (make-rational 1 2))
(mul (make-complex-from-real-imag (make-real 0.1) (make-integer 0)) (make-real 10.0))
(real-part (mul (make-complex-from-real-imag (make-real 0.1) (make-real 0.2)) (make-real 10.0)))
(imag-part (mul (make-complex-from-real-imag (make-real 0.1) (make-real 0.2)) (make-real 10.0)))
