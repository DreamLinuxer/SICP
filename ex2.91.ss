...
(define c (make-sparse-polynomial 'x '((5 1) (0 -1))))

c

(define d (make-dense-polynomial 'x '(1 0 -1)))

d

(define e (make-sparse-polynomial 'x '((0 1))))
...
(add (mul (car (div c d)) d) (cadr (div c d)))
