...
(add (make-integer 2) (make-rational 1 2))
(add (make-integer 2) (make-real 3.14))
(add (make-integer 2) (make-complex-from-real-imag 1 2))

(add (make-rational 1 2) (make-integer 2))
(add (make-rational 1 2) (make-real 3.14))
(add (make-rational 1 2) (make-complex-from-real-imag 1 2))

(add (make-real 1.5) (make-rational 1 2))
(add (make-real 1.5) (make-real 3.14))
(add (make-real 1.5) (make-complex-from-real-imag 1 2))
