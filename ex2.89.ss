...
(define (install-polynomial-package)
  ...
  (put 'add '(polynomial scheme-number)
       (lambda (p n) (tag (add-poly p (make-poly (variable p) (list n))))))
  (put 'add '(scheme-number polynomial)
       (lambda (n p) (tag (add-poly p (make-poly (variable p) (list n))))))
  (put 'mul '(polynomial scheme-number)
       (lambda (p n) (tag (mul-poly p (make-poly (variable p) (list n))))))
  (put 'mul '(scheme-number polynomial)
       (lambda (n p) (tag (mul-poly p (make-poly (variable p) (list n))))))
  (put 'sub '(polynomial scheme-number)
       (lambda (p n) (tag (sub-poly p (make-poly (variable p) (list n))))))
  (put 'sub '(scheme-number polynomial)
       (lambda (n p) (tag (sub-poly p (make-poly (variable p) (list n))))))
  'done)
...
(define a (make-polynomial 'x '(1 2 0 3 -2 -5)))

a

(define b (make-polynomial 'x '(1 2 1)))
