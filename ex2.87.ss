...
(=zero? (make-polynomial 'x '((2 1) (1 1) (0 1))))
(=zero? (make-polynomial 'x (list '(2 0) (list 1 (make-polynomial 'y '((4 0) (3 0)))))))
(=zero? (make-polynomial 'x (list '(2 0) (list 1 (make-polynomial 'y '((4 0) (2 1)))))))
